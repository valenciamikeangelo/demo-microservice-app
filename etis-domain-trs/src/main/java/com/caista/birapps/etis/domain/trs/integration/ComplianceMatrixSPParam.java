/*
  * Modified by: romerov
  * Last updated: 05 7, 20 4:21:23 PM
*/
package com.caista.birapps.etis.domain.trs.integration;

import java.util.Date;

public class ComplianceMatrixSPParam {
	...
	public ComplianceMatrixSPParam() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ComplianceMatrixSPParam(String createdBy, String taxTypeId, String taxTypeCode, String taxTypeDescription,
			String formTypeId, String formTypeCode, String formTypeDescription, String status, String filingFrequency,
			Long complianceMatrixId, Date legislativeDueDate, Date returnPeriod, Date systemRunDate, Date filingDate,
			String updateReason, Date givenDate) {
		super();
