/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:55:13 PM
 */
...
@Entity
@Table(name = "REF_ACCOUNTING_PERIOD",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"ACCOUNTING_PERIOD_CODE"},
        name = "UC_REF_ACCOUNTING_PERIOD_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceAccountingPeriod implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "ACCOUNTING_PERIOD_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "ACCOUNTING_PERIOD_CODE", nullable = false, updatable = false,
  ...
  @Column(name = "ITS_COLUMN", nullable = true, updatable = false)
  private Character itsColumn;
  ...
  public ReferenceAccountingPeriod() {
    super();
  }

  public ReferenceAccountingPeriod(String code) {
    this.code = code;
  }

  public ReferenceAccountingPeriod(String id, String code, String description, String createdBy,
  ...
  public Character getItsColumn() {
    return itsColumn;
  }

  public void setItsColumn(Character itsColumn) {
  ...
  public String toString() {
    return "ReferenceAccountingPeriod [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceAccountingPeriod other = (ReferenceAccountingPeriod) obj;
    if (code == null) {
      if (other.code != null)
        return false;
