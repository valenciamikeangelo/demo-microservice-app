/*
  * Modified by: tans
  * Last updated: May 19, 2020 11:22:30 AM
  */
...
@Entity
@Table(name = "REF_FIL_SUB_COMPLIANCE_CASE_TYPE",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"CASE_TYPE_CODE"},
        name = "UC_REF_CASE_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceFilSubComplianceCaseType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CASE_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "CASE_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceFilSubComplianceCaseType() {
    super();
  }

  public ReferenceFilSubComplianceCaseType(String code) {
    this.code = code;
  }

  public ReferenceFilSubComplianceCaseType(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferenceFilSubComplianceCaseType(String id, String code, String description, Date createdDate) {
	super();
	this.id = id;
	this.code = code;
	this.description = description;
  ...
  public ReferenceFilSubComplianceCaseType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceCaseType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceFilSubComplianceCaseType other = (ReferenceFilSubComplianceCaseType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
