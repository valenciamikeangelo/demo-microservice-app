/*
  * Modified by: obregoj
  * Last updated: Oct 25, 2019 12:39:54 PM
  */
...
@Entity
@Table(name = "REF_NOTICE_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"NOTICE_TYPE_CODE"}, name = "UC_REF_NOTICE_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceNoticeType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "NOTICE_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "NOTICE_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceNoticeType() {
    super();
  }

  public ReferenceNoticeType(String code) {
    this.code = code;
  }

  public ReferenceNoticeType(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferenceNoticeType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceNoticeType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceNoticeType other = (ReferenceNoticeType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
