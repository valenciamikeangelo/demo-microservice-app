/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:33 PM
 */
...
@Entity
@Table(name = "REF_CONTACT_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"CONTACT_TYPE_CODE"}, name = "UC_REF_CONTACT_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceContactType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CONTACT_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "CONTACT_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceContactType(String code) {
    this.code = code;
  }


  public ReferenceContactType(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferenceContactType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceContactType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceContactType other = (ReferenceContactType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
