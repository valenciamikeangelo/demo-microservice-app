/*
  * Modified by: obregoj
  * Last updated: Nov 20, 2019 9:14:38 AM
  */
...
@Entity
@Table(name = "REF_RELATIONSHIP_CATEGORY",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"RELATIONSHIP_CATEGORY_CODE"},
        name = "UC_REF_RELATIONSHIP_CATEGORY_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceRelationshipCategory implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "RELATIONSHIP_CATEGORY_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "RELATIONSHIP_CATEGORY_CODE", nullable = false, updatable = false,
  ...
  public ReferenceRelationshipCategory() {
    super();
  }

  public ReferenceRelationshipCategory(String code) {
    this.code = code;
  }

  public ReferenceRelationshipCategory(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferenceRelationshipCategory(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceRelationshipCategory [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceRelationshipCategory other = (ReferenceRelationshipCategory) obj;
    if (code == null) {
      if (other.code != null)
        return false;
