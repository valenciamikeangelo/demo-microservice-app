/*
  * Modified by: obregoj
  * Last updated: Nov 20, 2019 9:14:55 AM
  */
...
@Entity
@Table(name = "REF_TAXPAYER_CLASSIFICATION",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"TAXPAYER_CLASSIFICATION_CODE"},
        name = "UC_REF_TAXPAYER_CLASSIFICATION_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceTaxpayerClassification implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "TAXPAYER_CLASSIFICATION_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "TAXPAYER_CLASSIFICATION_CODE", nullable = false, updatable = false,
  ...
  public ReferenceTaxpayerClassification() {
    super();
  }

  public ReferenceTaxpayerClassification(String code) {
    super();
    this.code = code;
  }

  public ReferenceTaxpayerClassification(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public String toString() {
    return "ReferenceTaxpayerClassification [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceTaxpayerClassification other = (ReferenceTaxpayerClassification) obj;
    if (code == null) {
      if (other.code != null)
        return false;
