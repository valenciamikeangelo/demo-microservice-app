/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:58:46 PM
 */
...
@Entity
@Table(name = "REF_SPOUSE_EMPLOYMENT_STATUS",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"SPOUSE_EMPLOYMENT_STATUS_CODE"},
        name = "UC_REF_SPOUSE_EMPLOYMENT_STATUS_01")})
public class ReferenceSpouseEmploymentStatus implements Serializable, Auditable {
  /** The Constant serialVersionUID. */
  private static final long serialVersionUID = 1L;

  /** The code. */
  @Id
  @Column(name = "SPOUSE_EMPLOYMENT_STATUS_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "SPOUSE_EMPLOYMENT_STATUS_CODE", nullable = false, updatable = false,
  ...
  public ReferenceSpouseEmploymentStatus() {
    super();
    // TODO Auto-generated constructor stub
  }

  public ReferenceSpouseEmploymentStatus(String code) {
    this.code = code;
  }

  public ReferenceSpouseEmploymentStatus(String id, String code, String description,
  ...
  public String toString() {
    return "ReferenceSpouseEmploymentStatus [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceSpouseEmploymentStatus other = (ReferenceSpouseEmploymentStatus) obj;
    if (code == null) {
      if (other.code != null)
        return false;
