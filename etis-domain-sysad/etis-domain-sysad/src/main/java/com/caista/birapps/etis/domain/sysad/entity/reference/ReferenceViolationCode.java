...
@Entity
@Table(name = "REF_VIOLATION_CODE", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "VIOLATION_CODE_CODE" }, name = "UC_REF_VIOLATION_CODE_01") })
@JsonInclude(Include.NON_NULL)
public class ReferenceViolationCode implements Serializable, Auditable {
	...
	/** The code. */
	@Id
	@Column(name = "VIOLATION_CODE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
	private String id;

	@DedicatedLength(value = 30, name = "code")
	@Column(name = "VIOLATION_CODE_CODE", nullable = false, updatable = false, columnDefinition = "VARCHAR2(30)")
	private String code;
	...
	public ReferenceViolationCode() {
		super();
	}

	public ReferenceViolationCode(String code) {
		super();
		this.code = code;
	}

	public ReferenceViolationCode(String id, String code, String description) {
		super();
		this.id = id;
		this.code = code;
	...
	public ReferenceViolationCode(String id, String code, String description, String createdBy, Date createdDate,
	...
	public String toString() {
		return "ReferenceViolationCode [id=" + id + ", code=" + code + ", description=" + description + ", createdBy="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReferenceViolationCode other = (ReferenceViolationCode) obj;
		if (code == null) {
			if (other.code != null)
				return false;
