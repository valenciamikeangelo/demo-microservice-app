/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:46 PM
 */
...
@Entity
@Table(name = "REF_DLN_MODULE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"DLN_MODULE_CODE"}, name = "UC_REF_DLN_MODULE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceDlnModule implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "DLN_MODULE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "DLN_MODULE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceDlnModule() {
    super();
    // TODO Auto-generated constructor stub
  }

  public ReferenceDlnModule(String code) {
    this.code = code;
  }

  public ReferenceDlnModule(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceDlnModule [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceDlnModule other = (ReferenceDlnModule) obj;
    if (code == null) {
      if (other.code != null)
        return false;
