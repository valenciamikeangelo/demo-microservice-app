/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:59:17 PM
 */
...
@Entity
@Table(name = "REF_TIN_STATUS", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"TIN_STATUS_CODE"}, name = "UC_REF_TIN_STATUS_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceTinStatus implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "TIN_STATUS_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "TIN_STATUS_CODE", nullable = false, updatable = false,
  ...
  public ReferenceTinStatus() {
    super();
  }

  public ReferenceTinStatus(String code) {
    this.code = code;
  }


  public ReferenceTinStatus(String id, String code, String description, String createdBy,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceTinStatus other = (ReferenceTinStatus) obj;
    if (code == null) {
      if (other.code != null)
        return false;
