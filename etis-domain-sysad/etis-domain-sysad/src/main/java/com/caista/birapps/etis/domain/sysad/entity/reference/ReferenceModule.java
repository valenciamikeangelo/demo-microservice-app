/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 2:02:33 PM
 */
...
@Entity
@Table(name = "REF_MODULE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"MODULE_CODE"}, name = "UC_REF_MODULE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceModule implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "MODULE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;
  ...
  public ReferenceModule(String code) {
    this.code = code;
  }

  public ReferenceModule(String id, String code, String description, String createdBy,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceModule other = (ReferenceModule) obj;
    if (code == null) {
      if (other.code != null)
        return false;
