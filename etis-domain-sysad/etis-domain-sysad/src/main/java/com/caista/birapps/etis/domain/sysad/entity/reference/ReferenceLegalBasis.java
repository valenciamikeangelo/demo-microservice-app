/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:57:14 PM
 */
...
// @Entity
@Table(name = "REF_LEGAL_BASIS", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"LEGAL_BASIS_CODE"}, name = "UC_REF_LEGAL_BASIS_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceLegalBasis implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "LEGAL_BASIS_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "LEGAL_BASIS_CODE", nullable = false, updatable = false,
  ...
  public ReferenceLegalBasis() {
    super();
  }

  public ReferenceLegalBasis(String code) {
    this.code = code;
  }

  public ReferenceLegalBasis(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceLegalBasis [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceLegalBasis other = (ReferenceLegalBasis) obj;
    if (code == null) {
      if (other.code != null)
        return false;
