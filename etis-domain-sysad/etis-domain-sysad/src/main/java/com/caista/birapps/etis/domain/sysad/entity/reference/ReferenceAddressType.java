/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:29:35 PM
 */
...
@Entity
@Table(name = "REF_ADDRESS_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"ADDRESS_TYPE_CODE"}, name = "UC_REF_ADDRESS_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceAddressType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "ADDRESS_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "ADDRESS_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceAddressType() {
    super();
  }

  public ReferenceAddressType(String code) {
    this.code = code;
  }

  public ReferenceAddressType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceAddressType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceAddressType other = (ReferenceAddressType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
