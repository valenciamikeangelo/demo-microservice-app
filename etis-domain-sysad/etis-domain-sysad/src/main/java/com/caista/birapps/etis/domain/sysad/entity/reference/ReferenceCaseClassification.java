/*
  * Modified by: obregoj
  * Last updated: Jul 22, 2019 10:40:33 AM
  */
...
@Entity
@Table(name = "REF_CASE_CLASSIFICATION",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"CASE_CLASSIFICATION_CODE"},
        name = "UC_REF_CASE_CLASSIFICATION_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceCaseClassification implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CASE_CLASSIFICATION_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "CASE_CLASSIFICATION_CODE", nullable = false, updatable = false,
  ...
  public ReferenceCaseClassification() {
    super();
  }

  public ReferenceCaseClassification(String code) {
    this.code = code;
  }

  public ReferenceCaseClassification(String id, String code, String description, String createdBy,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceCaseClassification other = (ReferenceCaseClassification) obj;
    if (code == null) {
      if (other.code != null)
        return false;
