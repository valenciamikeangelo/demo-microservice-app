/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:57:06 PM
 */
...
/**
 * The Class ReferenceIncidentReportViolation.
 */
@Entity
@Table(name = "REF_INCIDENT_REPORT_VIOLATION",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"INCIDENT_REPORT_VIOLATION_CODE"},
        name = "UC_REF_INCIDENT_REPORT_VIOLATION_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceIncidentReportViolation implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "INCIDENT_REPORT_VIOLATION_ID", nullable = false,
      columnDefinition = "VARCHAR2(30)")
  private String id;

  /** The code. */
  @DedicatedLength(value = 30, name = "code")
  @Column(name = "INCIDENT_REPORT_VIOLATION_CODE", nullable = false, updatable = false,
      columnDefinition = "VARCHAR2(30)")
  private String code;

  /** The description. */
  @DedicatedLength(value = 150, name = "description")
  @Column(name = "DESCRIPTION", columnDefinition = "VARCHAR2(150)", nullable = false)
  ...
  /**
   * Instantiates a new reference incident report violation.
   */
  public ReferenceIncidentReportViolation() {
    super();
  }
   ...
   * @param code the code
   */
  public ReferenceIncidentReportViolation(String code) {
    super();
    this.code = code;
  }
   ...
   */
  public ReferenceIncidentReportViolation(String id, String code, String description,
  ...
  public String toString() {
    return "IncidentReportViolation [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceIncidentReportViolation other = (ReferenceIncidentReportViolation) obj;
    if (code == null) {
      if (other.code != null)
        return false;
