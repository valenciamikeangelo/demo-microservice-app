...
@Entity
@Table(name = "REF_DESIGNATION",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"DESIGNATION_CODE"},
        name = "UC_REF_DESIGNATION_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceDesignation implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "DESIGNATION_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "DESIGNATION_CODE", nullable = false, updatable = false,
  ...
  public ReferenceDesignation(String code) {
    this.code = code;
  }

  public ReferenceDesignation(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceDesignation [id=" + id + ", code=" + code + ", description="
