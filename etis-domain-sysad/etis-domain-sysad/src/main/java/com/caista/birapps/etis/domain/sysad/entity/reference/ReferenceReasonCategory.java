/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:58:09 PM
 */
...
@Entity
@Table(name = "REF_REASON_CATEGORY", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"REASON_CATEGORY_CODE"}, name = "UC_REF_REASON_CATEGORY_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceReasonCategory implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "REASON_CATEGORY_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "REASON_CATEGORY_CODE", nullable = false, updatable = false,
      columnDefinition = "VARCHAR2(30)")
  private String code;

  /** The description. */
  @DedicatedLength(value = 100, name = "description")
  @Column(name = "DESCRIPTION", columnDefinition = "VARCHAR2(100)", nullable = false)
  ...
  public ReferenceReasonCategory() {
    super();
  }

  public ReferenceReasonCategory(String code) {
    this.code = code;
  }

  public ReferenceReasonCategory(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferenceReasonCategory(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceReasonCategory [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceReasonCategory other = (ReferenceReasonCategory) obj;
    if (code == null) {
      if (other.code != null)
        return false;
