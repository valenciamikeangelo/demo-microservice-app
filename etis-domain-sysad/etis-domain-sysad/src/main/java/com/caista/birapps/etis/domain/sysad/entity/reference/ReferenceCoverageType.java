/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:42 PM
 */
...
@Entity
@Table(name = "REF_COVERAGE_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"COVERAGE_TYPE_CODE"}, name = "UC_REF_COVERAGE_TYPE_01")})
@JsonInclude(Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class ReferenceCoverageType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "COVERAGE_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 50, name = "code")
  @Column(name = "COVERAGE_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceCoverageType() {
    super();
  }

  public ReferenceCoverageType(String code) {
    this.code = code;
  }

  public ReferenceCoverageType(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferenceCoverageType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceCoverageType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceCoverageType other = (ReferenceCoverageType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
