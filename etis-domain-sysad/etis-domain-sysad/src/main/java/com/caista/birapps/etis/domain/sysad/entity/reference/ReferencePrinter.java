/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:58:04 PM
 */
...
@Entity
@Table(name = "REF_PRINTER", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"PRINTER_CODE"}, name = "UC_REF_PRINTER_01")})
@JsonInclude(Include.NON_NULL)
public class ReferencePrinter implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "PRINTER_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "PRINTER_CODE", nullable = false, updatable = false,
  ...
  public ReferencePrinter() {
    super();
  }

  public ReferencePrinter(String code) {
    this.code = code;
  }

  public ReferencePrinter(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferencePrinter(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferencePrinter [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferencePrinter other = (ReferencePrinter) obj;
    if (code == null) {
      if (other.code != null)
        return false;
