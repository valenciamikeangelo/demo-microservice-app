...
@Entity
@Table(name = "REF_BASIS_TYPE_AUDIT",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"BASIS_TYPE_AUDIT_CODE"},
        name = "UC_REF_BASIS_TYPE_AUDIT_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceBasisTypeAudit implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "BASIS_TYPE_AUDIT_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "BASIS_TYPE_AUDIT_CODE", nullable = false, updatable = false,
  ...
  public ReferenceBasisTypeAudit() {
    super();
  }

  public ReferenceBasisTypeAudit(String code) {
    this.code = code;
  }

  public ReferenceBasisTypeAudit(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceCaseStatus [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceBasisTypeAudit other = (ReferenceBasisTypeAudit) obj;
    if (code == null) {
      if (other.code != null)
        return false;
