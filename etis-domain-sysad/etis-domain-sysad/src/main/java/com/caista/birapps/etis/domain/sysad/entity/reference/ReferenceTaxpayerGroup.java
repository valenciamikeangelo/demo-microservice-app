/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:59:04 PM
 */
...
@Entity
@Table(name = "REF_TAXPAYER_GROUP", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"TAXPAYER_GROUP_CODE"}, name = "UC_REF_TAXPAYER_GROUP_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceTaxpayerGroup implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "TAXPAYER_GROUP_ID", nullable = false, columnDefinition = "VARCHAR2(100)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "TAXPAYER_GROUP_CODE", nullable = false, updatable = false,
  ...
  public ReferenceTaxpayerGroup() {
    super();
  }

  public ReferenceTaxpayerGroup(String code) {
    this.code = code;
  }

  public ReferenceTaxpayerGroup(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceTaxpayerGroup [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceTaxpayerGroup other = (ReferenceTaxpayerGroup) obj;
    if (code == null) {
      if (other.code != null)
        return false;
