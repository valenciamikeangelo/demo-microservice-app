/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:28 PM
 */
...
@Entity
@Table(name = "REF_CONTACT_PURPOSE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"CONTACT_PURPOSE_CODE"}, name = "UC_REF_CONTACT_PURPOSE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceContactPurpose implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CONTACT_PURPOSE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "CONTACT_PURPOSE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceContactPurpose() {
    super();
  }


  public ReferenceContactPurpose(String code) {
    this.code = code;
  }

  public ReferenceContactPurpose(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceContactPurpose [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceContactPurpose other = (ReferenceContactPurpose) obj;
    if (code == null) {
      if (other.code != null)
        return false;
