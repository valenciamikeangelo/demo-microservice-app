/*
  * Modified by: santosj
  * Last updated: Nov 6, 2019 4:14:36 PM
 */
...
@Entity
@Table(name = "REF_CASE_EVENT_ACTION",
uniqueConstraints = {@UniqueConstraint(columnNames = {"CASE_EVENT_ACTION_CODE"},
name = "UC_REF_CASE_EVENT_ACTION_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceCaseEventAction implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CASE_EVENT_ACTION_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "CASE_EVENT_ACTION_CODE", nullable = false, updatable = false,
  ...
  public ReferenceCaseEventAction() {
    super();
  }

  public ReferenceCaseEventAction(String code) {
    this.code = code;
  }

  public ReferenceCaseEventAction(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceCaseEventAction [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceCaseEventAction other = (ReferenceCaseEventAction) obj;
    if (code == null) {
      if (other.code != null)
        return false;
