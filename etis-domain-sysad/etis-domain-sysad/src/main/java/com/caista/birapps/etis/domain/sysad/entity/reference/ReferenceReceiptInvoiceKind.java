/*
  * Modified by: obregoj
  * Last updated: Nov 20, 2019 9:14:31 AM
  */
...
@Entity
@Table(name = "REF_RECEIPT_INVOICE_KIND",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"RECEIPT_INVOICE_KIND_CODE"},
        name = "UC_REF_RECEIPT_INVOICE_KIND_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceReceiptInvoiceKind implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "RECEIPT_INVOICE_KIND_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "RECEIPT_INVOICE_KIND_CODE", nullable = false, updatable = false,
  ...
  public ReferenceReceiptInvoiceKind() {
    super();
  }

  public ReferenceReceiptInvoiceKind(String code) {
    this.code = code;
  }

  public ReferenceReceiptInvoiceKind(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceReceiptInvoiceKind [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceReceiptInvoiceKind other = (ReferenceReceiptInvoiceKind) obj;
    if (code == null) {
      if (other.code != null)
        return false;
