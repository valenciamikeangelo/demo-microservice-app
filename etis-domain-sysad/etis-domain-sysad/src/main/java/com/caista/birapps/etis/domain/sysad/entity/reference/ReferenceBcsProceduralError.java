/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:55:51 PM
 */
...
/**
 * The Class ReferenceBcsProceduralError.
 */
@Entity
@Table(name = "REF_BCS_PROCEDURAL_ERROR",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"BCS_PROCEDURAL_ERROR_CODE"},
        name = "UC_REF_BCS_PROCEDURAL_ERROR_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceBcsProceduralError implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "BCS_PROCEDURAL_ERROR_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  /** The code. */
  @DedicatedLength(value = 30, name = "code")
  @Column(name = "BCS_PROCEDURAL_ERROR_CODE", nullable = false, updatable = false,
  ...
  /**
   * Instantiates a new reference bcs procedural error.
   */
  public ReferenceBcsProceduralError() {
    super();
  }
   ...
   * @param code the code
   */
  public ReferenceBcsProceduralError(String code) {
    super();
    this.code = code;
  }
   ...
   */
  public ReferenceBcsProceduralError(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "BcsProceduralError [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceBcsProceduralError other = (ReferenceBcsProceduralError) obj;
    if (code == null) {
      if (other.code != null)
        return false;
