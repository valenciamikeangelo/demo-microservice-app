/*
  * Modified by: obregoj
  * Last updated: Nov 20, 2019 9:14:44 AM
  */
...
@Entity
@Table(name = "REF_TAX_FORM_STATUS", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"TAX_FORM_STATUS_CODE"}, name = "UC_REF_TAX_FORM_STATUS_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceTaxFormStatus implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "TAX_FORM_STATUS_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "TAX_FORM_STATUS_CODE", nullable = false, updatable = false,
  ...
  /** The date updated. */
  @Column(name = "UPDATED_DATE", columnDefinition = "TIMESTAMP(6)", nullable = false)
  ...
  public ReferenceTaxFormStatus() {
    super();
    // TODO Auto-generated constructor stub
  }

  public ReferenceTaxFormStatus(String code) {
    this.code = code;
  }

  public ReferenceTaxFormStatus(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceTaxFormStatus [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceTaxFormStatus other = (ReferenceTaxFormStatus) obj;
    if (code == null) {
      if (other.code != null)
        return false;
