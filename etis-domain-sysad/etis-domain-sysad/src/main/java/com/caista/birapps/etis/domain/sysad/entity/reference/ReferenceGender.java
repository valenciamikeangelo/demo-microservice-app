/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:57:01 PM
 */
...
@Entity
@Table(name = "REF_GENDER", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"GENDER_CODE"}, name = "UC_REF_GENDER_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceGender implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "GENDER_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "GENDER_CODE", nullable = false, updatable = false,
      columnDefinition = "VARCHAR2(30)")
  private String code;

  /** The description. */
  @DedicatedLength(value = 11, name = "description")
  @Column(name = "DESCRIPTION", columnDefinition = "VARCHAR2(11)", nullable = false)
  ...
  public ReferenceGender() {
    super();
  }

  public ReferenceGender(String code) {
    this.code = code;
  }

  public ReferenceGender(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceGender [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceGender other = (ReferenceGender) obj;
    if (code == null) {
      if (other.code != null)
        return false;
