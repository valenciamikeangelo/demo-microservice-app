/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:38 PM
 */
...
@Entity
@Table(name = "REF_CORRESPONDENCE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"CORRESPONDENCE_CODE"}, name = "UC_REF_CORRESPONDENCE_01")})
public class ReferenceCorrespondence implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CORRESPONDENCE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "CORRESPONDENCE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceCorrespondence() {
    super();
    // TODO Auto-generated constructor stub
  }

  public ReferenceCorrespondence(String code) {
    this.code = code;
  }

  public ReferenceCorrespondence(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceCorrespondence [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceCorrespondence other = (ReferenceCorrespondence) obj;
    if (code == null) {
      if (other.code != null)
        return false;
