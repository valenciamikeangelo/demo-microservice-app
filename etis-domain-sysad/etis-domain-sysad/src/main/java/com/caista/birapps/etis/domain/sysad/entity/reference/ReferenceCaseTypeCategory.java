/*
  * Modified by: obregoj
  * Last updated: Oct 25, 2019 12:10:52 PM
  */
...
@Entity
@Table(name = "REF_CASE_TYPE_CATEGORY",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"CASE_TYPE_CATEGORY_CODE"},
        name = "UC_REF_CASE_TYPE_CATEGORY_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceCaseTypeCategory implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CASE_TYPE_CATEGORY_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "CASE_TYPE_CATEGORY_CODE", nullable = false, updatable = false,
  ...
  public ReferenceCaseTypeCategory() {
    super();
  }

  public ReferenceCaseTypeCategory(String code) {
    this.code = code;
  }



  public ReferenceCaseTypeCategory(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferenceCaseTypeCategory(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceCaseTypeCategory [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceCaseTypeCategory other = (ReferenceCaseTypeCategory) obj;
    if (code == null) {
      if (other.code != null)
        return false;
