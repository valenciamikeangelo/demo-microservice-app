/*
  * Modified by: logronj
  * Last updated: Oct 16, 2019 5:10:41 PM
  */
...
@Entity
@Table(name = "REF_TCC_RESTRICTION", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"TCC_RESTRICTION_CODE"}, name = "UC_REF_TCC_RESTRICTION_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceTccRestriction implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "TCC_RESTRICTION_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "TCC_RESTRICTION_CODE", nullable = false, updatable = false,
  ...
  public ReferenceTccRestriction() {
    super();
  }

  public ReferenceTccRestriction(String code) {
    this.code = code;
  }

  public ReferenceTccRestriction(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceSourceAgency [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceTccRestriction other = (ReferenceTccRestriction) obj;
    if (code == null) {
      if (other.code != null)
        return false;
