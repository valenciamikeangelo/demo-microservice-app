/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:55:42 PM
 */
...
@Entity
@Table(name = "REF_ATTACHMENT", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"ATTACHMENT_CODE"}, name = "UC_REF_ATTACHMENT_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceAttachment implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "ATTACHMENT_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "ATTACHMENT_CODE", nullable = false, updatable = false,
  ...
  public ReferenceAttachment(String code) {
    this.code = code;
  }

  public ReferenceAttachment(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceAttachment [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceAttachment other = (ReferenceAttachment) obj;
    if (code == null) {
      if (other.code != null)
        return false;
