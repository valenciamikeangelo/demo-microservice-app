/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:55:58 PM
 */
...
@Entity
@Table(name = "REF_BOOK_OF_ACCOUNT_TYPE",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"BOOK_OF_ACCOUNT_TYPE_CODE"},
        name = "UC_REF_BOOK_OF_ACCOUNT_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceBookOfAccountType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "BOOK_OF_ACCOUNT_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "BOOK_OF_ACCOUNT_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceBookOfAccountType() {
    super();
  }

  public ReferenceBookOfAccountType(String code) {
    this.code = code;
  }

  public ReferenceBookOfAccountType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceBookOfAccountType [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceBookOfAccountType other = (ReferenceBookOfAccountType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
