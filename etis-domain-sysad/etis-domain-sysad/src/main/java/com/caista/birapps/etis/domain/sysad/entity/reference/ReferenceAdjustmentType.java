/*
  * Modified by: obregoj
  * Last updated: Jun 28, 2019 11:13:36 AM
  */
...
@Entity
@Table(name = "REF_ADJUSTMENT_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"ADJUSTMENT_TYPE_CODE"}, name = "UC_REF_ADJUSTMENT_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceAdjustmentType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "ADJUSTMENT_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "ADJUSTMENT_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceAdjustmentType() {
    super();
  }

  public ReferenceAdjustmentType(String code) {
    this.code = code;
  }

  public ReferenceAdjustmentType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceAabType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceAdjustmentType other = (ReferenceAdjustmentType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
