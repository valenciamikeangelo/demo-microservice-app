...
@Entity
@Table(name = "REF_RETURN_TYPE", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "RETURN_TYPE_CODE" }, name = "UC_REF_RETURN_TYPE_01") })
@JsonInclude(Include.NON_NULL)
public class ReferenceReturnType implements Serializable, Auditable {
	...
	/** The code. */
	@Id
	@Column(name = "RETURN_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
	private String id;

	@DedicatedLength(value = 30, name = "code")
	@Column(name = "RETURN_TYPE_CODE", nullable = false, updatable = false, columnDefinition = "VARCHAR2(30)")
	private String code;
	...
	public ReferenceReturnType() {
		super();
	}

	public ReferenceReturnType(String code) {
		super();
		this.code = code;
	}

	public ReferenceReturnType(String id, String code, String description) {
		super();
		this.id = id;
		this.code = code;
	...
	public ReferenceReturnType(String id, String code, String description, String createdBy, Date createdDate,
	...
	public String toString() {
		return "ReferenceReturnType [id=" + id + ", code=" + code + ", description=" + description + ", createdBy="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReferenceReturnType other = (ReferenceReturnType) obj;
		if (code == null) {
			if (other.code != null)
				return false;
