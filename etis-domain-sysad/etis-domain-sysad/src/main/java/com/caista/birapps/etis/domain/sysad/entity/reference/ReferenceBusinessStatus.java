/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:04 PM
 */
...
@Entity
@Table(name = "REF_BUSINESS_STATUS", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"BUSINESS_STATUS_CODE"}, name = "UC_REF_BUSINESS_STATUS_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceBusinessStatus implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "BUSINESS_STATUS_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "BUSINESS_STATUS_CODE", nullable = false, updatable = false,
  ...
  public ReferenceBusinessStatus() {
    super();
  }

  public ReferenceBusinessStatus(String code) {
    this.code = code;
  }

  public ReferenceBusinessStatus(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceBusinessStatus [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceBusinessStatus other = (ReferenceBusinessStatus) obj;
    if (code == null) {
      if (other.code != null)
        return false;
