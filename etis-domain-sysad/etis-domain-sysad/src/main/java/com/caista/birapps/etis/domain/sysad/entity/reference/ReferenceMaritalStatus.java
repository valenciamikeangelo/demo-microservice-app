/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:57:22 PM
 */
...
@Entity
@Table(name = "REF_MARITAL_STATUS", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"MARITAL_STATUS_CODE"}, name = "UC_REF_MARITAL_STATUS_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceMaritalStatus implements Auditable {
  /** The Constant serialVersionUID. */
  private static final long serialVersionUID = 1L;

  /** The code. */
  @Id
  @Column(name = "REF_MARITAL_STATUS_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "MARITAL_STATUS_CODE", nullable = false, updatable = false,
  ...
  public ReferenceMaritalStatus() {
    super();
  }

  public ReferenceMaritalStatus(String code) {
    this.code = code;
  }

  public ReferenceMaritalStatus(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceMaritalStatus [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceMaritalStatus other = (ReferenceMaritalStatus) obj;
    if (code == null) {
      if (other.code != null)
        return false;
