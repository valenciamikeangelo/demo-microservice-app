 ...
 * Last updated date: Oct 23, 2019 3:12:08 PM
 */
...
public class MaintOfficeGroupRequest implements Serializable {
  ...
  public String toString() {
    return "MaintOfficeGroupRequest [code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    MaintOfficeGroupRequest other = (MaintOfficeGroupRequest) obj;
    if (code == null) {
      if (other.code != null)
        return false;
