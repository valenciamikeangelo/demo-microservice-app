/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:09 PM
 */
...
@Entity
@Table(name = "REF_CATEGORY", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"CATEGORY_CODE"}, name = "UC_REF_CATEGORY_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceCategory implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CATEGORY_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;
  ...
  public ReferenceCategory(String code) {
    this.code = code;
  }

  public ReferenceCategory(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceCategory [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceCategory other = (ReferenceCategory) obj;
    if (code == null) {
      if (other.code != null)
        return false;
