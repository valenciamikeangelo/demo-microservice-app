/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:57:10 PM
 */
...
@Entity
@Table(name = "REF_INDUSTRY_GROUP", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"INDUSTRY_GROUP_CODE"}, name = "UC_REF_INDUSTRY_GROUP_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceIndustryGroup implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "INDUSTRY_GROUP_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 50, name = "code")
  @Column(name = "INDUSTRY_GROUP_CODE", nullable = false, updatable = false,
      columnDefinition = "VARCHAR2(30)")
  private String code;

  /** The description. */
  @DedicatedLength(value = 115, name = "description")
  @Column(name = "DESCRIPTION", columnDefinition = "VARCHAR2(115)", nullable = false)
  ...
  public ReferenceIndustryGroup() {
    super();
    // TODO Auto-generated constructor stub
  }

  public ReferenceIndustryGroup(String code) {
    super();
    this.code = code;
  }

  public ReferenceIndustryGroup(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferenceIndustryGroup(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceIndustryGroup [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceIndustryGroup other = (ReferenceIndustryGroup) obj;
    if (code == null) {
      if (other.code != null)
        return false;
