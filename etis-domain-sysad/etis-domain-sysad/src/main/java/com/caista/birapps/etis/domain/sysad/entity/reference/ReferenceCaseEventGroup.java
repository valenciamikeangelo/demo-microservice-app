/*
  * Modified by: obregoj
  * Last updated: Oct 2, 2019 11:11:58 AM
  */
...
@Entity
@Table(name = "REF_CASE_EVENT_GROUP",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"CASE_EVENT_GROUP_CODE"},
        name = "UC_REF_CASE_EVENT_GROUP_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceCaseEventGroup implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CASE_EVENT_GROUP_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "CASE_EVENT_GROUP_CODE", nullable = false, updatable = false,
  ...
  public ReferenceCaseEventGroup() {
    super();
  }

  public ReferenceCaseEventGroup(String code) {
    this.code = code;
  }

  public ReferenceCaseEventGroup(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceCaseEventGroup [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceCaseEventGroup other = (ReferenceCaseEventGroup) obj;
    if (code == null) {
      if (other.code != null)
        return false;
