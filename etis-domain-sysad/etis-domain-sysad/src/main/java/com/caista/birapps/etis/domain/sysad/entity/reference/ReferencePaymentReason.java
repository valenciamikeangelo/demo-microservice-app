/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:57:57 PM
 */
...
@Entity
@Table(name = "REF_PAYMENT_REASON", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"PAYMENT_REASON_CODE"}, name = "UC_REF_PAYMENT_REASON_01")})
@JsonInclude(Include.NON_NULL)
public class ReferencePaymentReason implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "PAYMENT_REASON_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "PAYMENT_REASON_CODE", nullable = false, updatable = false,
  ...
  public String toString() {
    return "ReferencePaymentReason [id=" + id + ", code=" + code + ", description=" + description
        + ", createdBy=" + createdBy + ", createdDate=" + createdDate + ", updatedBy=" + updatedBy
        + ", updatedDate=" + updatedDate + ", effectiveDate=" + effectiveDate + ", expiryDate="
        + expiryDate + "]";
  }

  public ReferencePaymentReason(String id, String code, String description, String createdBy,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferencePaymentReason other = (ReferencePaymentReason) obj;
    if (code == null) {
      if (other.code != null)
        return false;
