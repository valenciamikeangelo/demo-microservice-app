/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 2:05:13 PM
 */
...
@Entity
@Table(name = "REF_ACCOUNTING_YEAR_START_MM",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"ACCOUNT_YEAR_START_MM_CODE"},
        name = "UC_REF_ACCOUNTING_YEAR_START_MM_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceAccountYearStartMonth implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "ACCOUNT_YEAR_START_MM_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "ACCOUNT_YEAR_START_MM_CODE", nullable = false, updatable = false,
  ...
  public ReferenceAccountYearStartMonth() {
    super();
  }

  public ReferenceAccountYearStartMonth(String code) {
    this.code = code;
  }

  public ReferenceAccountYearStartMonth(String id, String code, String description,
  ...
  public String toString() {
    return "ReferenceAccountingYearStartMonth [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceAccountYearStartMonth other = (ReferenceAccountYearStartMonth) obj;
    if (code == null) {
      if (other.code != null)
        return false;
