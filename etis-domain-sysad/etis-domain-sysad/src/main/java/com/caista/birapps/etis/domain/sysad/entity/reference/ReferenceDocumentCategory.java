/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:50 PM
 */
...
@Entity
@Table(name = "REF_DOCUMENT_CATEGORY",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"DOCUMENT_CATEGORY_CODE"},
        name = "UC_REF_DOCUMENT_CATEGORY_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceDocumentCategory implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "DOCUMENT_CATEGORY_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 50, name = "code")
  @Column(name = "DOCUMENT_CATEGORY_CODE", nullable = false, updatable = false,
      columnDefinition = "VARCHAR2(30)")
  private String code;

  /** The description. */
  @DedicatedLength(value = 80, name = "description")
  @Column(name = "DOCUMENT_CATEGORY_DESCRIPTION", columnDefinition = "VARCHAR2(80)",
      nullable = false)
  ...
  public ReferenceDocumentCategory() {
    super();
  }

  public ReferenceDocumentCategory(String code) {
    this.code = code;
  }

  public ReferenceDocumentCategory(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceAabOffice [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceDocumentCategory other = (ReferenceDocumentCategory) obj;
    if (code == null) {
      if (other.code != null)
        return false;
