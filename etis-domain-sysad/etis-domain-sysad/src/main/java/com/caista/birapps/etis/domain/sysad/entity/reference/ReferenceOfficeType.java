/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:57:36 PM
 */
...
@Entity
@Table(name = "REF_OFFICE_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"OFFICE_TYPE_CODE"}, name = "UC_REF_OFFICE_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceOfficeType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "OFFICE_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "OFFICE_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceOfficeType() {
    super();
  }

  public ReferenceOfficeType(String code) {
    super();
    this.code = code;
  }

  public ReferenceOfficeType(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  public ReferenceOfficeType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceOfficeType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceOfficeType other = (ReferenceOfficeType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
