/*
  * Modified by: obregoj
  * Last updated: Dec 4, 2019 1:28:09 PM
  */
...
@Entity
@Table(name = "REF_FORM_0500_SERIES_AUDIT_CATEGORY",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"FORM_0500_AUDIT_CATEGORY_CODE"},
        name = "UC_REF_FORM_0500_SERIES_AUDIT_CATEGORY_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceForm0500AuditCategory implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "FORM_0500_AUDIT_CATEGORY_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "FORM_0500_AUDIT_CATEGORY_CODE", nullable = false, updatable = false,
  ...
  public ReferenceForm0500AuditCategory() {
    super();
  }

  public ReferenceForm0500AuditCategory(String code) {
    this.code = code;
  }

  public ReferenceForm0500AuditCategory(String id, String code, String description,
  ...
  public String toString() {
    return "ReferenceCaseStatus [id=" + id + ", code=" + code + ", description=" + description
