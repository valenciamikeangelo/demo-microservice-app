/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:58:36 PM
 */
...
@Entity
@Table(name = "REF_SITE_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"SITE_TYPE_CODE"}, name = "UC_REF_SITE_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceSiteType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "SITE_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "SITE_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceSiteType() {
    super();
    // TODO Auto-generated constructor stub
  }

  public ReferenceSiteType(String code) {
    this.code = code;
  }

  public ReferenceSiteType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceSiteType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceSiteType other = (ReferenceSiteType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
