/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:58:24 PM
 */
...
@Entity
@Table(name = "REF_REPORT_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"REPORT_TYPE_CODE"}, name = "UC_REF_REPORT_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceReportType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "REPORT_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "REPORT_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceReportType() {
    super();
  }

  public ReferenceReportType(String code) {
    this.code = code;
  }

  public ReferenceReportType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceReportType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceReportType other = (ReferenceReportType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
