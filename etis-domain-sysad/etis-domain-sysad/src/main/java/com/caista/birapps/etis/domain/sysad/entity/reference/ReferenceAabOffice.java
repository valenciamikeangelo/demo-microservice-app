/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:54:27 PM
 */
...
@Entity
@Table(name = "REF_AAB_OFFICE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"AAB_OFFICE_CODE"}, name = "UC_REF_AAB_OFFICE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceAabOffice implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "AAB_OFFICE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "AAB_OFFICE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceAabOffice() {
    super();
  }

  public ReferenceAabOffice(String code) {
    this.code = code;
  }

  public ReferenceAabOffice(String id, String code, String description, String createdBy,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceAabOffice other = (ReferenceAabOffice) obj;
    if (code == null) {
      if (other.code != null)
        return false;
