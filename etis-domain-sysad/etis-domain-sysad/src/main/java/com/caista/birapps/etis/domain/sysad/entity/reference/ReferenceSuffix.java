/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:58:51 PM
 */
...
@Entity
@Table(name = "REF_SUFFIX", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"SUFFIX_CODE"}, name = "UC_REF_SUFFIX_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceSuffix implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "SUFFIX_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "SUFFIX_CODE", nullable = false, updatable = false,
  ...
  public ReferenceSuffix() {
    super();
    // TODO Auto-generated constructor stub
  }

  public ReferenceSuffix(String code) {
    this.code = code;
  }

  public ReferenceSuffix(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceSuffix [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceSuffix other = (ReferenceSuffix) obj;
    if (code == null) {
      if (other.code != null)
        return false;
