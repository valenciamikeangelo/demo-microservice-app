/*
  * Modified by: obregoj
  * Last updated: Nov 20, 2019 9:11:51 AM
  */
...
@Table(name = "MAIN_BANK",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"BANK_CODE"}, name = "UC_MAIN_BANK_01")},
    indexes = {@Index(columnList = "BANK_CODE", name = "IDX_MAIN_BANK_01")})
@JsonInclude(Include.NON_NULL)
public class MaintBank implements Serializable, Auditable {

  private static final long serialVersionUID = 1L;

  @Id
  @IrisIdGenerator(name = "BANK", type = GeneratorTypeEnum.TEXTS_AND_NUMBERS,
      uniqueProperty = "none")
  @Column(name = "BANK_ID", unique = true, nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @Column(name = "BANK_CODE", nullable = false, columnDefinition = "VARCHAR2(10)")
  private String code;

  @Column(name = "BANK_DESCRIPTION", nullable = false, columnDefinition = "VARCHAR2(100)")
  ...
  public MaintBank(String id, String code, String description) {
    super();
    this.id = id;
    this.code = code;
  ...
  // USER RETURN
  public MaintBank(String id, String code, String description, String governmentDepositBankFlag,
      String statusFlag) {
    super();
    this.id = id;
    this.code = code;
  ...
  // ADMIN RETURN
  public MaintBank(String id, String code, String description, String governmentDepositBankFlag,
      String statusFlag, Date effectiveDate, Date expiryDate, Date updatedDate) {
    super();
    this.id = id;
    this.code = code;
    this.description = description;
  ...
  public MaintBank(String id, String code, String description, String governmentDepositBankFlag,
      String statusFlag, Date effectiveDate, Date expiryDate, String createdBy, Date createdDate,
