/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:22 PM
 */
...
@Entity
@Table(name = "REF_CLAIM_ADDITIONAL_DEDUCTION",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"CLAIM_ADDITIONAL_DEDUCTION_CODE"},
        name = "UC_REF_CLAIM_ADDITIONAL_DEDUCTION_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceClaimAdditionalDeduction implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "CLAIM_ADDITIONAL_DEDUCTION_ID", nullable = false,
      columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "CLAIM_ADDITIONAL_DEDUCTION_CODE", nullable = false, updatable = false,
      columnDefinition = "VARCHAR2(30)")
  private String code;
  ...
  public ReferenceClaimAdditionalDeduction() {
    super();
    // TODO Auto-generated constructor stub
  }

  public ReferenceClaimAdditionalDeduction(String code) {
    this.code = code;
  }

  public ReferenceClaimAdditionalDeduction(String id, String code, String description,
  ...
  public String toString() {
    return "ReferenceClaimAdditionalDeduction [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceClaimAdditionalDeduction other = (ReferenceClaimAdditionalDeduction) obj;
    if (code == null) {
      if (other.code != null)
        return false;
