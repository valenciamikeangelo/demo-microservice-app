/*
  * Modified by: logronj
  * Last updated: Oct 16, 2019 5:10:33 PM
  */
...
@Table(name = "REF_MANNER_OF_ISSUANCE",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"MANNER_OF_ISSUANCE_CODE"},
        name = "UC_REF_MANNER_OF_ISSUANCE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceMannerOfIssuance implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "MANNER_OF_ISSUANCE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "MANNER_OF_ISSUANCE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceMannerOfIssuance() {
    super();
  }

  public ReferenceMannerOfIssuance(String code) {
    this.code = code;
  }

  public ReferenceMannerOfIssuance(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceMannerOfIssuance [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceMannerOfIssuance other = (ReferenceMannerOfIssuance) obj;
    if (code == null) {
      if (other.code != null)
        return false;
