/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:56:56 PM
 */
 ...
 */
@Entity
@Table(name = "REF_FACILITY_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"FACILITY_TYPE_CODE"}, name = "UC_REF_FACILITY_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceFacilityType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "FACILITY_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "FACILITY_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceFacilityType() {
    super();
  }

  public ReferenceFacilityType(String code) {
    this.code = code;
  }

  public ReferenceFacilityType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceFacilityType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceFacilityType other = (ReferenceFacilityType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
