/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:59:43 PM
 */
...
@Table(name = "REF_TITLE",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"TITLE_CODE"}, name = "UC_REF_TITLE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceTitle implements Serializable, Auditable {
  /** The Constant serialVersionUID. */
  private static final long serialVersionUID = 1L;

  /** The code. */
  @Id
  @Column(name = "TITLE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "TITLE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceTitle(String code) {
    this.code = code;
  }

  public ReferenceTitle(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceTitle [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceTitle other = (ReferenceTitle) obj;
    if (code == null) {
      if (other.code != null)
        return false;
