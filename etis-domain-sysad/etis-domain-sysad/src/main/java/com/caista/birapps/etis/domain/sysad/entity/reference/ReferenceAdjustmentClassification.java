/*
  * Modified by: abenirm
  * Last updated: Sept 30, 2019 10:40:33 AM
  */
...
@Entity
@Table(name = "REF_ADJUSTMENT_CLASSIFICATION",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"ADJUSTMENT_CLASSIFICATION_CODE"},
        name = "UC_REF_ADJUSTMENT_CLASSIFICATION_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceAdjustmentClassification implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "ADJUSTMENT_CLASSIFICATION_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "ADJUSTMENT_CLASSIFICATION_CODE", nullable = false, updatable = false,
  ...
  public ReferenceAdjustmentClassification() {
    super();
  }

  public ReferenceAdjustmentClassification(String code) {
    this.code = code;
  }

  public ReferenceAdjustmentClassification(String id, String code, String description, String createdBy,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceAdjustmentClassification other = (ReferenceAdjustmentClassification) obj;
    if (code == null) {
      if (other.code != null)
        return false;
