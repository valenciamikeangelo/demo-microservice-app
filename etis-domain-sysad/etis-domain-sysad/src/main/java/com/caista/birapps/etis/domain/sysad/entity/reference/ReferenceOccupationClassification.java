/*
  * Modified by: obregoj
  * Last updated: Nov 20, 2019 9:14:22 AM
  */
...
@Entity
@Table(name = "REF_OCCUPATION_CLASSIFICATION",
    uniqueConstraints = {
        @UniqueConstraint(columnNames = {"OCCUPATION_CLASSIFICATION_CODE", "DESCRIPTION"},
            name = "UC_REF_OCCUPATION_CLASSIFICATION_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceOccupationClassification implements Serializable, Auditable {
  /** The Constant serialVersionUID. */
  private static final long serialVersionUID = 1L;

  /** The code. */
  @Id
  @Column(name = "OCCUPATION_CLASSIFICATION_ID", nullable = false,
      columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 50, name = "code")
  @Column(name = "OCCUPATION_CLASSIFICATION_CODE", nullable = false, updatable = false,
      columnDefinition = "VARCHAR2(30)")
  private String code;

  /** The description. */
  @DedicatedLength(value = 100, name = "description")
  ...
  public ReferenceOccupationClassification() {
    super();
  }

  public ReferenceOccupationClassification(String code) {
    this.code = code;
  }

  public ReferenceOccupationClassification(String id, String code, String description,
  ...
  public String toString() {
    return "ReferenceOccupationClassification [id=" + id + ", code=" + code + ", description="
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceOccupationClassification other = (ReferenceOccupationClassification) obj;
    if (code == null) {
      if (other.code != null)
        return false;
