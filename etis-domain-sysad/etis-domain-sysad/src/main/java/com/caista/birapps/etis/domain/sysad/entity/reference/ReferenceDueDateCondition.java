...
@Entity
@Table(name = "REF_DUE_DATE_CONDITION", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "DUE_DATE_CONDITION_CODE" }, name = "UC_REF_VIOLATION_CODE_01") })
@JsonInclude(Include.NON_NULL)
public class ReferenceDueDateCondition implements Serializable, Auditable {
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** The code. */
	@Id
	@Column(name = "DUE_DATE_CONDITION_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
	private String id;

	@DedicatedLength(value = 30, name = "code")
	@Column(name = "DUE_DATE_CONDITION_CODE", nullable = false, updatable = false, columnDefinition = "VARCHAR2(30)")
	private String code;
	...
	public ReferenceDueDateCondition() {
		super();
	}

	public ReferenceDueDateCondition(String code) {
		super();
		this.code = code;
	}

	public ReferenceDueDateCondition(String id, String code, String description) {
		super();
		this.id = id;
		this.code = code;
	...
	public ReferenceDueDateCondition(String id, String code, String description, String createdBy, Date createdDate,
	...
	public String toString() {
		return "ReferenceDueDateCondition [id=" + id + ", code=" + code + ", description=" + description
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReferenceDueDateCondition other = (ReferenceDueDateCondition) obj;
		if (code == null) {
			if (other.code != null)
				return false;
