/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:58:01 PM
 */
...
@Entity
@Table(name = "REF_PRE_GEN_TIN_SOURCE",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"PRE_GEN_TIN_SOURCE_CODE"},
        name = "UC_REF_PRE_GEN_TIN_SOURCE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferencePreGenTinSource implements Serializable, Auditable {
  /** The Constant serialVersionUID. */
  private static final long serialVersionUID = 1L;

  /** The code. */
  @Id
  @Column(name = "PRE_GEN_TIN_SOURCE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "PRE_GEN_TIN_SOURCE_CODE", nullable = false, updatable = false,
  ...
  public ReferencePreGenTinSource() {
    super();
  }

  public ReferencePreGenTinSource(String code) {
    this.code = code;
  }

  public ReferencePreGenTinSource(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferencePreGenTinSource [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferencePreGenTinSource other = (ReferencePreGenTinSource) obj;
    if (code == null) {
      if (other.code != null)
        return false;
