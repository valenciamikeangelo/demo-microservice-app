/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:59:08 PM
 */
...
@Entity
@Table(name = "REF_TAX_REGIME_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"TAX_REGIME_TYPE_CODE"}, name = "UC_REF_TAX_REGIME_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceTaxRegimeType implements Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "TAX_REGIME_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "TAX_REGIME_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceTaxRegimeType() {
    super();
  }


  public ReferenceTaxRegimeType(String code) {
    this.code = code;
  }

  public ReferenceTaxRegimeType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceTaxRegimeType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceTaxRegimeType other = (ReferenceTaxRegimeType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
