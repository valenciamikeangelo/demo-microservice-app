/*
  * Modified by: logronj
  * Last updated: Oct 16, 2019 5:10:46 PM
  */
...
@Entity
@Table(name = "REF_SOURCE_AGENCY", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"SOURCE_AGENCY_CODE"}, name = "UC_REF_SOURCE_AGENCY_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceSourceAgency implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "SOURCE_AGENCY_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "SOURCE_AGENCY_CODE", nullable = false, updatable = false,
  ...
  public ReferenceSourceAgency() {
    super();
  }

  public ReferenceSourceAgency(String code) {
    this.code = code;
  }

  public ReferenceSourceAgency(String id, String code, String description, String createdBy,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceSourceAgency other = (ReferenceSourceAgency) obj;
    if (code == null) {
      if (other.code != null)
        return false;
