/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:55:34 PM
 */
...
@Table(name = "REF_APPLICATION_INDICATOR",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"APPLICATION_INDICATOR_CODE"},
        name = "UC_REF_APPLICATION_INDICATOR_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceApplicationIndicator implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "APPLICATION_INDICATOR_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "APPLICATION_INDICATOR_CODE", nullable = false, updatable = false,
  ...
  public ReferenceApplicationIndicator() {
    super();
  }

  public ReferenceApplicationIndicator(String code) {
    this.code = code;
  }

  public ReferenceApplicationIndicator(String id, String code, String description, String createdBy,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceApplicationIndicator other = (ReferenceApplicationIndicator) obj;
    if (code == null) {
      if (other.code != null)
        return false;
