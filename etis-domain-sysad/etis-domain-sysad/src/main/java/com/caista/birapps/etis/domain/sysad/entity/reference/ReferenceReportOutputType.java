/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:58:20 PM
 */
...
@Table(name = "REF_REPORT_OUTPUT_TYPE",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"REPORT_OUTPUT_TYPE_CODE"},
        name = "UC_REF_REPORT_OUTPUT_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceReportOutputType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "REPORT_OUTPUT_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "REPORT_OUTPUT_TYPE_CODE", nullable = false, updatable = false,
      columnDefinition = "VARCHAR2(30)")
  private String code;

  /** The description. */
  @DedicatedLength(value = 50, name = "description")
  @Column(name = "DESCRIPTION", columnDefinition = "VARCHAR2(50)", nullable = false)
  ...
  public ReferenceReportOutputType() {
    super();
  }

  public ReferenceReportOutputType(String code) {
    this.code = code;
  }

  public ReferenceReportOutputType(String id, String code, String description, String createdBy,
  ...
  public String toString() {
    return "ReferenceReportOutputType [id=" + id + ", code=" + code + ", description=" + description
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceReportOutputType other = (ReferenceReportOutputType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
