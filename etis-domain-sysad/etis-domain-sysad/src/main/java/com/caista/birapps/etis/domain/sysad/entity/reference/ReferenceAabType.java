/*
 * Modified by: santojo
 * Last updated: Apr 8, 2019 1:54:55 PM
 */
...
@Entity
@Table(name = "REF_AAB_TYPE", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"AAB_TYPE_CODE"}, name = "UC_REF_AAB_TYPE_01")})
@JsonInclude(Include.NON_NULL)
public class ReferenceAabType implements Serializable, Auditable {
  ...
  /** The code. */
  @Id
  @Column(name = "AAB_TYPE_ID", nullable = false, columnDefinition = "VARCHAR2(30)")
  private String id;

  @DedicatedLength(value = 30, name = "code")
  @Column(name = "AAB_TYPE_CODE", nullable = false, updatable = false,
  ...
  public ReferenceAabType() {
    super();
  }

  public ReferenceAabType(String code) {
    this.code = code;
  }

  public ReferenceAabType(String id, String code, String description, String createdBy,
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ReferenceAabType other = (ReferenceAabType) obj;
    if (code == null) {
      if (other.code != null)
        return false;
